...
const ArticleContainer = () => {
    ...
    return (
        <>
            ...
            <hr />
                <div className='row '>
                    <ArticleRow src1={ArticleSrc[0].src1} src2={ArticleSrc[0].src2} src3={ArticleSrc[0].src3}></ArticleRow>
                    <ArticleRow src1={ArticleSrc[1].src1} src2={ArticleSrc[1].src2} src3={ArticleSrc[1].src3}></ArticleRow>
